 ...
 where: {
    ...
    return (
        <div className="bg-white p-4 rounded-md">
         ...
         <span className="text-xs text-gray-400">استعراض الكل</span>
        ...
        <p className="text-sm text-gray-400 mt-1 text-right" dir="rtl">{data[0].description}</p>
        </div>}
            {data[1] &&
        ...
        <p className="text-sm text-gray-400 mt-1 text-right" dir="rtl">{data[1].description}</p>
        </div>}
        {data[2] &&
        ...
        <p className="text-sm text-gray-400 mt-1 text-right" dir="rtl">{data[2].description}</p>
        </div>}
        </div>
        </div>
    )
