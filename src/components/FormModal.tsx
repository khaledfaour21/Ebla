...
const forms: {
 ...
 //parent: (type,data,setOpen) => <ParentForm type={type} data={data} setOpen={setOpen} relatedData={relatedData}/>,
   ...
   const Form =() => {
    ...
    return type ==="delete" && id ? (
        <form action={formAction} className="p-4 flex flex-col gap-4">
            ...
            <button className="bg-red-700 text-white py-2 px-4 rounded-md boeder-none w-max self-center">Delete</button>
         </form>
