    ...
    return (
        <div className="flex items-center justify-between p-4">
         ...
         <div className="flex flex-col">
                <span className="text-xs leading-3 font-medium">Navbar.tsx</span>
                <span className="text-[10px] text-gray-500 text-center">{user?.publicMetadata.role as string}</span>
            </div>
